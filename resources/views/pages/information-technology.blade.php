...
<p>Please fill in the form below following every information technology meeting:</p>
...
<form>
    <div class="form-group1">
        ...
        <div>
            ...
            <br>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Insert date (dd/mm/yy)">
            <br><br>
        ...
        <div class="form-group">
            ...
            <textarea name="" id="" cols="25" rows="2" placeholder="list not present"></textarea>
    ...
    <div class="form-group2">
        ...
        <div>
            ...
            <textarea name="" id="" cols="60" rows="10" placeholder="List actions"></textarea>
        </div>
        ...
        <div>
            ...
            <br>
            <textarea name="" id="" cols="60" rows="10" placeholder="List key decisions"></textarea>
        ...
        <div>
            ...
            <br>
            <textarea name="" id="" cols="60" rows="10" placeholder="List matters arising"></textarea>
    ...
    <div class="form-group3">
        <div>
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Insert link" size="40">
            <br>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Insert link" size="40">
            <br>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Insert link" size="40">
