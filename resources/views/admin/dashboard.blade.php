            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-md-6 text-right">
                        <h5>Telegram Message Bot: @if(\App\Models\BotException::where('id',1)->first()->telegram_bot == 0)  <span class="badge badge-pill badge-success">Live</span> @else {{ \App\Models\BotException::where('id',1)->first()->telegram_bot }} @endif </h5>
                    </div>
                </div>
